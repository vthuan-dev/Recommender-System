    ...
    <div class="trangchu">
        ...
        <div class="dangnhap-dangky">
            ...
            if (isset($_SESSION["phonenumber"])) {
                ...
                echo "<a ../admin/logout.php'><i class='fas fa-sign-out-alt'></i> Đăng xuất</a>";
            } else {
...
<div class="pagebody">
    ...
    <div><h2>Tin tức</h2></div>
    <hr>
    <!-- HTML -->
    <div class="news-list">
    <div class="news-item">
        <h3>Giảm giá sốt dẻo!</h3>
        <p>Chúng tôi đang có chương trình giảm giá đặc biệt! Hãy nhanh chóng đến cửa hàng của chúng tôi để không bỏ lỡ cơ hội!</p>
        <img style="width:70%" src="https://s3v2.interdata.vn:9000/s3-586-15343-storage/dienthoaigiakho/wp-content/uploads/2022/05/31012158/1200x1200_Key-Tra-Gop_2208.jpg" alt="Sale Image">
    </div>
    </div>
